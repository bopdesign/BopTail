...
use function BopTail\Hooks\Filters\get_post_content;
...
function get_svg( $args = [] ) {
	...
	if ( empty( $args ) ) {
		return esc_attr__( 'Please define default parameters in the form of an array.', BOPTAIL_TEXT_DOMAIN );
	}

	// Define an icon.
	if ( false === array_key_exists( 'icon', $args ) ) {
		return esc_attr__( 'Please define an SVG icon filename.', BOPTAIL_TEXT_DOMAIN );
	}
