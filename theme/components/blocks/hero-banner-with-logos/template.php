		...
		<div class="<?php echo esc_attr( $container_class ); ?>">
			...
			<div class="basis-full self-end pt-10 lg:pt-16">
				...
				<div class="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-0 gap-y-10 sm:max-w-xl sm:grid-cols-6 lg:mx-0 lg:max-w-none lg:grid-cols-5">
					<img class="col-span-2 max-h-12 w-full object-contain object-center lg:col-span-1 px-4 border-l border-white" src="https://tailwindui.com/plus-assets/img/logos/158x48/transistor-logo-white.svg" alt="Transistor" width="158" height="48">
					<img class="col-span-2 max-h-12 w-full object-contain object-center lg:col-span-1 px-4 border-l border-white" src="https://tailwindui.com/plus-assets/img/logos/158x48/reform-logo-white.svg" alt="Reform" width="158" height="48">
					<img class="col-span-2 max-h-12 w-full object-contain object-center lg:col-span-1 px-4 border-l border-white" src="https://tailwindui.com/plus-assets/img/logos/158x48/tuple-logo-white.svg" alt="Tuple" width="158" height="48">
					<img class="col-span-2 max-h-12 w-full object-contain object-center lg:col-span-1 px-4 border-l border-white" src="https://tailwindui.com/plus-assets/img/logos/158x48/savvycal-logo-white.svg" alt="SavvyCal" width="158" height="48">
					<img class="col-span-2 max-h-12 w-full object-contain object-center lg:col-span-1 px-4 border-l border-r border-white" src="https://tailwindui.com/plus-assets/img/logos/158x48/statamic-logo-white.svg" alt="Statamic" width="158" height="48">
				</div>
			</div>
		</div>
	</section>
